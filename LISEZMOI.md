# Mouse Cursor Maker - Turbo Pascal - MS-Dos - 1991

[This page in English.](README.md)

Aussi étrange que cela puisse paraître la souris existait sous MS-Dos sur PC avant Windows. On devait y accéder en assembleur en faisant appel à l'interruption 33h du système mais une fois la chose maîtrisée c'était assez facile de détecter les changements de position du curseur.

On pouvait également modifier la forme du curseur de la souris. Je m'en servais notamment sur mes jeux vidéo.

Voici donc le programme qui me permettait de dessiner de nouvelles souris et de prendre en charge mon format de fichier MOU (pour "mouse").

"MkMouse" a été codé avec [Turbo Pascal](https://fr.wikipedia.org/wiki/Turbo_Pascal) en 1991.
